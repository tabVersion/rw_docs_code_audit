...
- If something is missing/unclear, record it under **Pending actions** (R&D/Test) or **Open questions** and continue.
...
- **Observed code behavior**: summarize what the code actually does, backed by evidence above
...
### 4) Turn uncertainties into pending actions (when possible)
...
### 5) Output a report (strict format)
